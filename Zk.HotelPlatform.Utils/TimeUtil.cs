...
namespace Zk.HotelPlatform.Utils
{
    ...
    public class TimeUtil
    {
        ...
        public static DateTime UnixStampToDateTime(string unixTimeStamp)
        {
        ...
        /// <returns></returns>
        public static DateTime UnixStampMSToDateTime(string unixTimeStamp)
        {
            System.DateTime startTime = TimeZone.CurrentTimeZone.ToLocalTime(new System.DateTime(1970, 1, 1));

            DateTime dt = startTime.AddMilliseconds(long.Parse(unixTimeStamp));
        ...
        /// <summary>
        /// 把格式/Date(1665676800000+0800)/的时间处理为时间
        /// </summary>
        /// <param name="timeStamp"></param>
        /// <returns></returns>
    ...
    public static class DateExt
    {
        ...
        {
            if (!date.HasValue)
                return new DateTime(1970, 1, 1, 23, 59, 59);
